...
typedef struct {
  ...
  real_T UnitDelay4_DSTATE_b;          /* '<S30>/Unit Delay4' */
  ...
  real32_T DelayInput2_DSTATE_mb;      /* '<S39>/Delay Input2' */
  ...
  real32_T DelayInput2_DSTATE_o;       /* '<S40>/Delay Input2' */
  real32_T UnitDelay5_DSTATE_ip;       /* '<S28>/Unit Delay5' */
  real32_T UnitDelay_DSTATE_nr;        /* '<S28>/Unit Delay' */
  real32_T UnitDelay1_DSTATE_g;        /* '<S28>/Unit Delay1' */
  ...
  real32_T UnitDelay1_DSTATE_gu;       /* '<S30>/Unit Delay1' */
