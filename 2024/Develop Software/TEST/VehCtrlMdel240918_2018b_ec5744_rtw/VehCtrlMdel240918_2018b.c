...
static void VehCtrlMdel240918_2018b_VehStat(const real_T *MCFL_bQuitInverterOn_k,
  const real_T *MCFL_bSystemReady_i, const real_T *MCFR_bQuitInverterOn_d, const
  real_T *MCFR_bSystemReady_g, const real_T *controller_ready_e, int32_T
  *sfEvent);
...
void VehCtrlMdel240918_2018b_step3(void) /* Sample time: [0.01s, 0.0s] */
{
  ...
  if (VehCtrlMdel240918_2018b_DW.bitsForTID3.is_active_c1_VehCtrlMdel240918_ ==
    ...
    if (VehCtrlMdel240918_2018b_DW.bitsForTID3.is_active_VehStat != 0U) {
      VehCtrlMdel240918_2018b_VehStat(&MCFL_bQuitInverterOn, &MCFL_bSystemReady,
        &MCFR_bQuitInverterOn, &MCFR_bSystemReady, &controller_ready, &sfEvent);
    }
      ...
      switch (VehCtrlMdel240918_2018b_DW.bitsForTID3.is_AMKDCready) {
       ...
       case VehCtrlMdel240918_IN_SYSRDYCECK:
        rtb_LogicalOperator2 = ((VehCtrlMdel240918_2018b_DW.temporalCounter_i2 >=
          1000U) && (MCFL_bSystemReady != 0.0) && (MCFR_bSystemReady != 0.0));
        if (rtb_LogicalOperator2) {
  ...
  rtb_LowerRelop1_b = (TroqueOn || rtb_UpperRelop_ir || (Trq_CUT != 0.0));
