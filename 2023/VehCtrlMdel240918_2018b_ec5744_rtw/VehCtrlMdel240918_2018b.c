...
real_T Gear_Trs;                       /* '<S310>/Switch2' */
real_T Mode_Trs;                       /* '<S310>/Switch3' */
real_T Trq_CUT;                        /* '<S176>/Timer' */
real_T ignition;                       /* '<S101>/Timer' */
real_T L12V_error;                     /* '<S154>/CAN Unpack' */
real_T alarm;                          /* '<S154>/CAN Unpack' */
real_T controller_ready;               /* '<S154>/CAN Unpack' */
real_T selfcheck;                      /* '<S154>/CAN Unpack' */
real_T RPM;                            /* '<S154>/CAN Unpack' */
real_T trq;                            /* '<S154>/CAN Unpack' */
real_T AC_current;                     /* '<S149>/CAN Unpack' */
real_T DC_current;                     /* '<S149>/CAN Unpack' */
real_T MCU_Temp;                       /* '<S149>/CAN Unpack' */
real_T motor_Temp;                     /* '<S149>/CAN Unpack' */
...
real_T MCFL_ActualVelocity;            /* '<S113>/CAN Unpack' */
...
real_T StrWhlAngAliveRollCnt;          /* '<S167>/CAN Unpack1' */
real_T StrWhlAng;                      /* '<S167>/CAN Unpack1' */
real_T StrWhlAngV;                     /* '<S167>/CAN Unpack1' */
...
real_T IMU_Ay_Value;                   /* '<S162>/CAN Unpack' */
real_T IMU_Ax_Value;                   /* '<S162>/CAN Unpack' */
real_T IMU_Yaw_Value;                  /* '<S162>/CAN Unpack' */
uint32_T Acc_vol;                      /* '<S176>/Add2' */
uint32_T Acc_vol2;                     /* '<S176>/Add3' */
uint32_T Acc_POS1;                     /* '<S176>/1-D Lookup Table' */
uint32_T Acc_POS2;                     /* '<S176>/1-D Lookup Table3' */
uint16_T F_BrkPrs;                     /* '<S176>/1-D Lookup Table1' */
...
{
  /* Call the system: <S318>/CCPReceive */
  {
    /* S-Function (ec5744_caninterruptslb1): '<S318>/ReceiveandTransmitInterrupt' */

    /* Output and update for function-call system: '<S318>/CCPReceive' */

    /* S-Function (ec5744_canreceiveslb): '<S334>/CANReceive' */
    ...
    /* Nothing to do for system: <S334>/Nothing */

    /* End of Outputs for S-Function (ec5744_canreceiveslb): '<S334>/CANReceive' */

    /* End of Outputs for S-Function (ec5744_caninterruptslb1): '<S318>/ReceiveandTransmitInterrupt' */
  }
...
{
  /* S-Function (fcncallgen): '<S318>/Function-Call Generator' incorporates:
   *  SubSystem: '<S318>/CCPBackground'
   */

  /* S-Function (ec5744_ccpslb): '<S333>/CCPBackground' */
  ccpBackground();
  Lin0_Background();

  /* End of Outputs for S-Function (fcncallgen): '<S318>/Function-Call Generator' */
}

/* Model step function for TID2 */
void VehCtrlMdel240918_2018b_step2(void) /* Sample time: [0.005s, 0.0s] */
{
  /* S-Function (fcncallgen): '<S316>/5ms' incorporates:
   *  SubSystem: '<S316>/daq5ms'
   */

  /* S-Function (ec5744_ccpslb1): '<S331>/CCPDAQ' */
  ccpDaq(0);

  /* End of Outputs for S-Function (fcncallgen): '<S316>/5ms' */
}
...
void VehCtrlMdel240918_2018b_step3(void) /* Sample time: [0.01s, 0.0s] */
{
  ...
  /* Receive CAN message */
  {
    ...
    VehCtrlMdel240918_2018b_B.CANReceive1_o2= ec_can_receive(0,2, CAN0BUF2RX);
    VehCtrlMdel240918_2018b_B.CANReceive1_o4[0]= CAN0BUF2RX[can0buf2looprx];
    can0buf2looprx++;
    VehCtrlMdel240918_2018b_B.CANReceive1_o4[1]= CAN0BUF2RX[can0buf2looprx];
    can0buf2looprx++;
    VehCtrlMdel240918_2018b_B.CANReceive1_o4[2]= CAN0BUF2RX[can0buf2looprx];
    can0buf2looprx++;
    VehCtrlMdel240918_2018b_B.CANReceive1_o4[3]= CAN0BUF2RX[can0buf2looprx];
    can0buf2looprx++;
    VehCtrlMdel240918_2018b_B.CANReceive1_o4[4]= CAN0BUF2RX[can0buf2looprx];
    can0buf2looprx++;
    VehCtrlMdel240918_2018b_B.CANReceive1_o4[5]= CAN0BUF2RX[can0buf2looprx];
    can0buf2looprx++;
    VehCtrlMdel240918_2018b_B.CANReceive1_o4[6]= CAN0BUF2RX[can0buf2looprx];
    can0buf2looprx++;
    VehCtrlMdel240918_2018b_B.CANReceive1_o4[7]= CAN0BUF2RX[can0buf2looprx];
    can0buf2looprx++;
  }
  ...
  /* Outputs for Enabled SubSystem: '<S147>/MCU_VCUMeter1' incorporates:
  ...
  /* End of Outputs for SubSystem: '<S147>/MCU_VCUMeter1' */
  ...
  /* Receive CAN message */
  {
    ...
    VehCtrlMdel240918_2018b_B.CANReceive3_o2= ec_can_receive(0,1, CAN0BUF1RX);
    VehCtrlMdel240918_2018b_B.CANReceive3_o4[0]= CAN0BUF1RX[can0buf1looprx];
    can0buf1looprx++;
    VehCtrlMdel240918_2018b_B.CANReceive3_o4[1]= CAN0BUF1RX[can0buf1looprx];
    can0buf1looprx++;
    VehCtrlMdel240918_2018b_B.CANReceive3_o4[2]= CAN0BUF1RX[can0buf1looprx];
    can0buf1looprx++;
    VehCtrlMdel240918_2018b_B.CANReceive3_o4[3]= CAN0BUF1RX[can0buf1looprx];
    can0buf1looprx++;
    VehCtrlMdel240918_2018b_B.CANReceive3_o4[4]= CAN0BUF1RX[can0buf1looprx];
    can0buf1looprx++;
    VehCtrlMdel240918_2018b_B.CANReceive3_o4[5]= CAN0BUF1RX[can0buf1looprx];
    can0buf1looprx++;
    VehCtrlMdel240918_2018b_B.CANReceive3_o4[6]= CAN0BUF1RX[can0buf1looprx];
    can0buf1looprx++;
    VehCtrlMdel240918_2018b_B.CANReceive3_o4[7]= CAN0BUF1RX[can0buf1looprx];
    can0buf1looprx++;
  }
  ...
  /* Outputs for Enabled SubSystem: '<S166>/IMU_state' incorporates:
  ...
  if (VehCtrlMdel240918_2018b_B.CANReceive3_o2_p > 0) {
    ...
    /* S-Function (scanunpack): '<S167>/CAN Unpack1' */
    {
      /* S-Function (scanunpack): '<S167>/CAN Unpack1' */
  ...
  /* End of Outputs for SubSystem: '<S166>/IMU_state' */
  ...
  VehCtrlMdel240918_2018b_B.Acc1= adc_read_chan(1,2);

  /* S-Function (ec5744_asislbu3): '<S96>/Acc2' */

  /* Read the ADC conversion result of the analog signal */
  VehCtrlMdel240918_2018b_B.Acc2= adc_read_chan(1,4);
  ...
  /* Outputs for Enabled SubSystem: '<S161>/MCU_state' incorporates:
  ...
  /* End of Outputs for SubSystem: '<S161>/MCU_state' */
  ...
  /* Outputs for Enabled SubSystem: '<S145>/IMU_state' incorporates:
  ...
  /* End of Outputs for SubSystem: '<S145>/IMU_state' */
  ...
  /* UnitDelay: '<S176>/Unit Delay1' incorporates:
   *  UnitDelay: '<S176>/Unit Delay'
   */
  ...
  /* Lookup_n-D: '<S176>/1-D Lookup Table' */
  ...
  /* Lookup_n-D: '<S176>/1-D Lookup Table2' incorporates:
   *  UnitDelay: '<S176>/Unit Delay'
   */
  ...
  /* Logic: '<S176>/Logical Operator6' */
  rtb_Compare_am = (rtb_Compare_am || rtb_LowerRelop1_b);

  /* Logic: '<S176>/Logical Operator7' */
  ...
  /* UnitDelay: '<S223>/Delay Input2'
   *
   * Block description for '<S223>/Delay Input2':
   *
   *  Store in Global RAM
   */
  rtb_Gain5 = VehCtrlMdel240918_2018b_DW.DelayInput2_DSTATE_a;

  /* SampleTimeMath: '<S223>/sample time'
   *
   * About '<S223>/sample time':
   *  y = K where K = ( w * Ts )
   */
  elapseTime = (real_T)FunctionCallSubsystem_ELAPS_T * 0.01;

  /* Product: '<S223>/delta rise limit' */
  rtb_Yk1_l = 10.0 * elapseTime;

  /* Sum: '<S223>/Difference Inputs1'
   *
   * Block description for '<S223>/Difference Inputs1':
   *
   *  Add in CPU
   */
   ...
   *  Sum: '<S223>/Difference Inputs2'
   *  UnitDelay: '<S223>/Delay Input2'
   *
   * Block description for '<S223>/Difference Inputs2':
   *
   *  Add in CPU
   *
   * Block description for '<S223>/Delay Input2':
  ...
  /* Chart: '<S179>/Timer' incorporates:
   *  Constant: '<S179>/Constant5'
   */
  VehCtrlMdel240918_20_Timer1(rtb_ignition, 0.11F,
    &VehCtrlMdel240918_2018b_B.Exit_le, &VehCtrlMdel240918_2018b_DW.sf_Timer_b);

  /* UnitDelay: '<S224>/Delay Input2'
   *
   * Block description for '<S224>/Delay Input2':
   *
   *  Store in Global RAM
   */
  rtb_Yk1_l = VehCtrlMdel240918_2018b_DW.DelayInput2_DSTATE_b;

  /* SampleTimeMath: '<S224>/sample time'
   *
   * About '<S224>/sample time':
   *  y = K where K = ( w * Ts )
   */
  elapseTime = (real_T)FunctionCallSubsystem_ELAPS_T * 0.01;

  /* Product: '<S224>/delta rise limit' */
  rtb_Gain4 = 10.0 * elapseTime;

  /* Sum: '<S224>/Difference Inputs1'
   *
   * Block description for '<S224>/Difference Inputs1':
   *
   *  Add in CPU
   */
   ...
   *  Sum: '<S224>/Difference Inputs2'
   *  UnitDelay: '<S224>/Delay Input2'
   *
   * Block description for '<S224>/Difference Inputs2':
   *
   *  Add in CPU
   *
   * Block description for '<S224>/Delay Input2':
  ...
  /* Chart: '<S179>/Timer1' incorporates:
   *  Constant: '<S179>/Constant1'
   */
  VehCtrlMdel240918_20_Timer1(rtb_ignition, 0.11F,
    &VehCtrlMdel240918_2018b_B.Exit_i, &VehCtrlMdel240918_2018b_DW.sf_Timer1_n);

  /* UnitDelay: '<S225>/Delay Input2'
   *
   * Block description for '<S225>/Delay Input2':
   *
   *  Store in Global RAM
   */
  rtb_Yk1_l = VehCtrlMdel240918_2018b_DW.DelayInput2_DSTATE_h;

  /* SampleTimeMath: '<S225>/sample time'
   *
   * About '<S225>/sample time':
   *  y = K where K = ( w * Ts )
   */
  elapseTime = (real_T)FunctionCallSubsystem_ELAPS_T * 0.01;

  /* Product: '<S225>/delta rise limit' */
  rtb_Switch2_on = 10.0 * elapseTime;

  /* Sum: '<S225>/Difference Inputs1'
   *
   * Block description for '<S225>/Difference Inputs1':
   *
   *  Add in CPU
   */
  ...
  /* Saturate: '<S179>/Saturation2' incorporates:
   *  Sum: '<S225>/Difference Inputs2'
   *  UnitDelay: '<S225>/Delay Input2'
   *
   * Block description for '<S225>/Difference Inputs2':
   *
   *  Add in CPU
   *
   * Block description for '<S225>/Delay Input2':
  ...
  /* Chart: '<S179>/Timer2' incorporates:
  ...
  /* Chart: '<S179>/Timer3' incorporates:
  ...
  /* Lookup_n-D: '<S178>/1-D Lookup Table1' */
  rtb_Switch2_on = look1_binlx(rtb_UkYk1,
  ...
  /* UnitDelay: '<S200>/Delay Input2'
   *
   * Block description for '<S200>/Delay Input2':
   *
   *  Store in Global RAM
   */
  rtb_UkYk1 = VehCtrlMdel240918_2018b_DW.DelayInput2_DSTATE_l;

  /* SampleTimeMath: '<S200>/sample time'
   *
   * About '<S200>/sample time':
   *  y = K where K = ( w * Ts )
   */
  elapseTime = (real_T)FunctionCallSubsystem_ELAPS_T * 0.01;

  /* Product: '<S200>/delta rise limit' incorporates:
  ...
  /* Sum: '<S200>/Difference Inputs1'
   *
   * Block description for '<S200>/Difference Inputs1':
   *
   *  Add in CPU
   */
  rtb_Add2 -= rtb_UkYk1;
  ...
  /* Switch: '<S206>/Switch2' */
  if (!rtb_LowerRelop1_b) {
    /* Product: '<S200>/delta fall limit' incorporates:
  ...
  /* Sum: '<S200>/Difference Inputs2' incorporates:
   *  UnitDelay: '<S200>/Delay Input2'
   *
   * Block description for '<S200>/Difference Inputs2':
   *
   *  Add in CPU
   *
   * Block description for '<S200>/Delay Input2':
  ...
  /* RelationalOperator: '<S203>/LowerRelop1' incorporates:
  ...
  if (rtb_LowerRelop1_b) {
    ...
    /* RelationalOperator: '<S203>/UpperRelop' incorporates:
  ...
  /* Product: '<S201>/delta rise limit' incorporates:
  ...
  /* Switch: '<S207>/Switch2' */
  if (!rtb_LowerRelop1_b) {
    /* Product: '<S201>/delta fall limit' incorporates:
  ...
  if (rtb_LowerRelop1_b) {
    ...
    /* RelationalOperator: '<S204>/UpperRelop' incorporates:
  ...
  /* Switch: '<S208>/Switch2' */
  if (!rtb_LowerRelop1_b) {
    /* Product: '<S202>/delta fall limit' incorporates:
  ...
  /* Saturate: '<S199>/Saturation2' incorporates:
  ...
  /* DataTypeConversion: '<S175>/Cast To Double1' */
  rtb_Add7 = (real32_T)WhlSpdFL;

  /* DataTypeConversion: '<S175>/Cast To Double6' */
  rtb_Add6_p = (real32_T)FLWhlStrAng;

  /* Gain: '<S238>/Gain2' */
  rtb_Add6_p *= 0.0174532924F;

  /* Trigonometry: '<S238>/Asin' */
  rtb_Add6_p = cosf(rtb_Add6_p);

  /* Product: '<S238>/Product1' */
  rtb_Add7 *= rtb_Add6_p;

  /* DataTypeConversion: '<S175>/Cast To Double5' */
  ...
  /* DataTypeConversion: '<S175>/Cast To Double7' */
  rtb_Add10 = (real32_T)rtb_Yk1_l;

  /* Gain: '<S238>/Gain3' */
  rtb_Add10 *= 0.0174532924F;

  /* Trigonometry: '<S238>/Asin1' */
   ...
   *  Constant: '<S245>/steptime1'
   */
  rtb_deltafalllimit_n = rtb_Add10 / 0.01F;

  /* RelationalOperator: '<S260>/LowerRelop1' incorporates:
  ...
  if (rtb_Compare) {
    ...
    /* RelationalOperator: '<S260>/UpperRelop' incorporates:
  ...
  /* Sum: '<S259>/Difference Inputs2' incorporates:
   *  UnitDelay: '<S259>/Delay Input2'
   *
   ...
   *  Constant: '<S245>/steptime2'
   */
  rtb_deltafalllimit_om = rtb_Add4_j / 0.01F;

  /* RelationalOperator: '<S263>/LowerRelop1' incorporates:
  ...
  if (rtb_LogicalOperator5_o) {
    ...
    /* RelationalOperator: '<S263>/UpperRelop' incorporates:
  ...
  /* Sum: '<S262>/Difference Inputs2' incorporates:
   *  UnitDelay: '<S262>/Delay Input2'
   *
  ...
  /* DataTypeConversion: '<S175>/Cast To Double4' */
  ...
  /* UnitDelay: '<S279>/Delay Input2'
   *
   * Block description for '<S279>/Delay Input2':
   *
   *  Store in Global RAM
   */
  rtb_Switch2_mn = VehCtrlMdel240918_2018b_DW.DelayInput2_DSTATE_el;

  /* SampleTimeMath: '<S279>/sample time'
   *
   * About '<S279>/sample time':
   *  y = K where K = ( w * Ts )
   */
  elapseTime = (real_T)FunctionCallSubsystem_ELAPS_T * 0.01;

  /* Product: '<S279>/delta rise limit' */
  rtb_Add6_p = (real32_T)(20.0 * elapseTime);

  /* UnitDelay: '<S246>/Unit Delay5' */
  ...
  /* Product: '<S246>/Divide1' incorporates:
   *  Constant: '<S246>/steptime1'
   */
  rtb_Add4_j /= 0.01F;
  ...
  /* Sum: '<S246>/Add10' incorporates:
   *  UnitDelay: '<S246>/Unit Delay5'
   */
  rtb_Add7 = VehCtrlMdel240918_2018b_DW.UnitDelay5_DSTATE - rtb_Add7;

  /* Product: '<S246>/Divide5' incorporates:
   *  Constant: '<S246>/steptime5'
   */
  rtb_Add7 /= 0.01F;

  /* RelationalOperator: '<S280>/LowerRelop1' incorporates:
  ...
  if (rtb_Compare_am) {
    ...
    /* RelationalOperator: '<S280>/UpperRelop' incorporates:
  ...
  /* Sum: '<S279>/Difference Inputs1'
   *
   * Block description for '<S279>/Difference Inputs1':
   *
   *  Add in CPU
   */
  rtb_Add7 -= rtb_Switch2_mn;
  ...
  /* Sum: '<S279>/Difference Inputs2' incorporates:
   *  UnitDelay: '<S279>/Delay Input2'
   *
   * Block description for '<S279>/Difference Inputs2':
   *
   *  Add in CPU
   *
   * Block description for '<S279>/Delay Input2':
  ...
  /* Sum: '<S246>/Add14' incorporates:
   *  UnitDelay: '<S246>/Unit Delay7'
   */
  rtb_Add7 = VehCtrlMdel240918_2018b_DW.UnitDelay7_DSTATE - rtb_Add7;

  /* Product: '<S246>/Divide7' incorporates:
   *  Constant: '<S246>/steptime7'
   */
  rtb_Add7 /= 0.01F;
  ...
  /* Chart: '<S236>/Timer1' incorporates:
  ...
  /* Chart: '<S236>/Timer2' incorporates:
  ...
  /* Chart: '<S236>/Timer3' incorporates:
  ...
  /* Switch: '<S237>/Switch13' incorporates:
   ...
   */
  if (rtb_LowerRelop1_b) {
    /* Sum: '<S235>/Add10' incorporates:
     *  Constant: '<S235>/Steptime'
     */
   ...
   *  Constant: '<S235>/ResetDelay'
   */
  VehCtrlMdel240918_2018b_DW.UnitDelay2_DSTATE_i = fminf(rtb_Add10, 0.1F);

  /* RelationalOperator: '<S235>/Relational Operator9' incorporates:
   *  Constant: '<S235>/ResetDelay'
  ...
  /* Chart: '<S237>/Timer2' incorporates:
   *  Constant: '<S237>/Constant15'
   */
  VehCtrlMdel240918_20_Timer1(rtb_LogicalOperator5_o, 0.11F,
  ...
  /* Chart: '<S237>/Timer1' incorporates:
   *  Constant: '<S237>/Constant14'
   */
  VehCtrlMdel240918_20_Timer1(rtb_LogicalOperator5_o, 0.11F,
  ...
  /* Switch: '<S237>/Switch6' incorporates:
   *  Switch: '<S237>/Switch4'
   */
  if (rtb_LowerRelop1_b) {
    /* Switch: '<S237>/Switch5' incorporates:
     *  UnitDelay: '<S297>/Delay Input2'
     *
     * Block description for '<S297>/Delay Input2':
     *
    ...
    if (VehCtrlMdel240918_2018b_B.Exit != 0.0) {
      /* Switch: '<S237>/Switch11' incorporates:
      ...
      /* End of Switch: '<S237>/Switch11' */

      /* Switch: '<S237>/Switch10' incorporates:
      ...
      /* End of Switch: '<S237>/Switch10' */

      /* Switch: '<S237>/Switch9' incorporates:
      ...
      /* End of Switch: '<S237>/Switch9' */

      /* Switch: '<S237>/Switch8' incorporates:
  ...
  /* Switch: '<S237>/Switch7' incorporates:
   *  UnitDelay: '<S297>/Delay Input2'
   *
   * Block description for '<S297>/Delay Input2':
   *
  ...
  /* Switch: '<S237>/Switch12' incorporates:
  ...
  /* Update for MinMax: '<S298>/Min3' incorporates:
   *  UnitDelay: '<S252>/Unit Delay'
   *  UnitDelay: '<S256>/Delay Input2'
   *
   * Block description for '<S256>/Delay Input2':
  ...
  /* Update for UnitDelay: '<S245>/Unit Delay2' */
  ...
  /* Update for UnitDelay: '<S275>/Unit Delay' incorporates:
   *  UnitDelay: '<S285>/Delay Input2'
   *
   * Block description for '<S285>/Delay Input2':
   *
  ...
  /* Update for UnitDelay: '<S246>/Unit Delay3' */
  ...
  /* Update for UnitDelay: '<S235>/Unit Delay4' */
  VehCtrlMdel240918_2018b_DW.UnitDelay4_DSTATE_m = rtb_Acc_POS;

  /* Update for UnitDelay: '<S235>/Unit Delay3' */
  VehCtrlMdel240918_2018b_DW.UnitDelay3_DSTATE_f = rtb_ignition;

  /* Update for UnitDelay: '<S237>/Unit Delay3' incorporates:
   *  UnitDelay: '<S237>/Unit Delay1'
   */
   ...
   *  SubSystem: '<S5>/Beeper'
   */
  /* S-Function (ec5744_pdsslbu3): '<S307>/PowerDriverSwitch(HS)' */
   ...
   */
  /* S-Function (scanpack): '<S308>/CAN Pack1' incorporates:
   *  Constant: '<S308>/Constant'
   *  Constant: '<S308>/Constant1'
   */
  /* S-Function (scanpack): '<S308>/CAN Pack1' */
  ...
  /* S-Function (ecucoder_canmessage): '<S308>/CANPackMessage' */
  ...
  /* S-Function (ec5744_cantransmitslb): '<S308>/CANTransmit' */
   ...
   */
  /* S-Function (scanpack): '<S309>/CAN Pack1' incorporates:
   *  Constant: '<S309>/Constant'
   *  Constant: '<S309>/Constant1'
   */
  /* S-Function (scanpack): '<S309>/CAN Pack1' */
  ...
  /* S-Function (ecucoder_canmessage): '<S309>/CANPackMessage' */
  ...
  /* S-Function (ec5744_cantransmitslb): '<S309>/CANTransmit' */
   ...
   *  Constant: '<S310>/Constant13'
   *  Constant: '<S310>/Constant17'
   *  Constant: '<S310>/Constant19'
   *  Constant: '<S310>/Constant20'
   *  Switch: '<S310>/Switch3'
   */
  if (rtb_LogicalOperator3) {
    Gear_Trs = 0.0;
  ...
  /* DataTypeConversion: '<S310>/Cast To Boolean4' */
  VehCtrlMdel240918_2018b_B.CastToBoolean4 = (uint16_T)Gear_Trs;

  /* DataTypeConversion: '<S310>/Cast To Boolean6' */
  ...
  /* S-Function (scanpack): '<S310>/CAN Pack1' */
  /* S-Function (scanpack): '<S310>/CAN Pack1' */
  ...
  /* S-Function (ecucoder_canmessage): '<S310>/CANPackMessage' */
  ...
  /* S-Function (ec5744_cantransmitslb): '<S310>/CANTransmit' */
   ...
   */
  /* DataTypeConversion: '<S311>/Cast To Single1' */
  ...
  /* S-Function (ec5744_pdpslbu3): '<S311>/PowerDriverPWM' incorporates:
  ...
  /* S-Function (fcncallgen): '<S316>/10ms' incorporates:
   *  SubSystem: '<S316>/daq10ms'
   */
  /* S-Function (ec5744_ccpslb1): '<S328>/CCPDAQ' */
  ccpDaq(1);

  /* End of Outputs for S-Function (fcncallgen): '<S316>/10ms' */
...
{
  /* S-Function (fcncallgen): '<S316>/50ms' incorporates:
   *  SubSystem: '<S316>/daq50ms'
   */

  /* S-Function (ec5744_ccpslb1): '<S330>/CCPDAQ' */
  ccpDaq(2);

  /* End of Outputs for S-Function (fcncallgen): '<S316>/50ms' */
}

/* Model step function for TID5 */
void VehCtrlMdel240918_2018b_step5(void) /* Sample time: [0.1s, 0.0s] */
{
  /* S-Function (fcncallgen): '<S315>/100MS' incorporates:
   *  SubSystem: '<S315>/Function-Call Subsystem'
   */
  /* S-Function (ec5744_canreceiveslb): '<S319>/CANReceive' */
  ...
  /* Call the system: <S319>/Function-Call Subsystem */

  /* Output and update for function-call system: '<S319>/Function-Call Subsystem' */
  {
    uint8_T rtb_Add;
    uint8_T rtb_Compare;
    ...
    if (VehCtrlMdel240918_2018b_B.CANReceive_o2_p > 0) {
      ...
      /* If: '<S321>/If' */
      if (rtb_Compare > 0) {
        /* Outputs for IfAction SubSystem: '<S321>/If Action Subsystem' incorporates:
         *  ActionPort: '<S325>/Action Port'
         */
        /* S-Function (ec5744_bootloaderslb): '<S325>/BootLoader' */
        {
          uint16 i= 0;
          N256K_BLOCK_SEL n256KBlockSelect;
          CONTEXT_DATA pgmCtxData;
        ...
        /* S-Function (ec5744_cpuresetslb): '<S325>/CPUReset' */

        /* Perform a microcontroller reset */
        MC_ME.MCTL.R = 0X00005AF0;
        MC_ME.MCTL.R = 0X0000A50F;

        /* End of Outputs for SubSystem: '<S321>/If Action Subsystem' */
      } else {
        /* Outputs for IfAction SubSystem: '<S321>/If Action Subsystem1' incorporates:
         *  ActionPort: '<S326>/Action Port'
         */
        /* S-Function (ec5744_cantransmitslb): '<S326>/CANTransmit' incorporates:
        ...
        /* End of Outputs for SubSystem: '<S321>/If Action Subsystem1' */
      }
  ...
  /* End of Outputs for S-Function (ec5744_canreceiveslb): '<S319>/CANReceive' */
  /* End of Outputs for S-Function (fcncallgen): '<S315>/100MS' */

  /* S-Function (fcncallgen): '<S316>/100ms' incorporates:
   *  SubSystem: '<S316>/daq100ms'
   */
  /* S-Function (ec5744_ccpslb1): '<S327>/CCPDAQ' */
  ccpDaq(3);

  /* End of Outputs for S-Function (fcncallgen): '<S316>/100ms' */
}

/* Model step function for TID6 */
void VehCtrlMdel240918_2018b_step6(void) /* Sample time: [0.5s, 0.0s] */
{
  /* S-Function (fcncallgen): '<S316>/500ms' incorporates:
   *  SubSystem: '<S316>/daq500ms'
   */

  /* S-Function (ec5744_ccpslb1): '<S329>/CCPDAQ' */
  ccpDaq(4);

  /* End of Outputs for S-Function (fcncallgen): '<S316>/500ms' */

  /* S-Function (fcncallgen): '<S317>/500ms' incorporates:
   *  SubSystem: '<S317>/EEPROMOperation'
   */

  /* S-Function (ec5744_eepromoslb): '<S332>/EEPROMOperatin' */
  ...
  /* End of Outputs for S-Function (fcncallgen): '<S317>/500ms' */
}
...
void VehCtrlMdel240918_2018b_initialize(void)
{
  ...
  /* Start for Enabled SubSystem: '<S147>/MCU_VCUMeter1' */

  /* Start for S-Function (scanunpack): '<S149>/CAN Unpack' */

  /*-----------S-Function Block: <S149>/CAN Unpack -----------------*/

  /* End of Start for SubSystem: '<S147>/MCU_VCUMeter1' */
  ...
  /* Start for Enabled SubSystem: '<S166>/IMU_state' */

  /* Start for S-Function (scanunpack): '<S167>/CAN Unpack1' */

  /*-----------S-Function Block: <S167>/CAN Unpack1 -----------------*/

  /* End of Start for SubSystem: '<S166>/IMU_state' */
  ...
  /* Start for Enabled SubSystem: '<S161>/MCU_state' */

  /* Start for S-Function (scanunpack): '<S162>/CAN Unpack' */

  /*-----------S-Function Block: <S162>/CAN Unpack -----------------*/

  /* End of Start for SubSystem: '<S161>/MCU_state' */
  ...
  /* Start for S-Function (ec5744_cantransmitslb): '<S308>/CANTransmit' */
  ec_buffer_init(1,8,0,386U);

  /* End of Start for S-Function (fcncallgen): '<S5>/10ms2' */
  /* Start for S-Function (ec5744_cantransmitslb): '<S309>/CANTransmit' */
  ec_buffer_init(1,9,0,387U);

  /* End of Start for S-Function (fcncallgen): '<S5>/10ms4' */
  /* Start for S-Function (ec5744_cantransmitslb): '<S310>/CANTransmit' */
   ...
   *  SubSystem: '<S5>/WP_OUTPUT'
   */
  /* Start for S-Function (ec5744_pdpslbu3): '<S311>/PowerDriverPWM' incorporates:
   *  Constant: '<S311>/Constant'
   */
  ...
  /* Start for S-Function (fcncallgen): '<S315>/100MS' incorporates:
   *  SubSystem: '<S315>/Function-Call Subsystem'
   */
  /* Start for S-Function (ec5744_canreceiveslb): '<S319>/CANReceive' incorporates:
   *  SubSystem: '<S319>/Function-Call Subsystem'
   */
  /* Start for function-call system: '<S319>/Function-Call Subsystem' */

  /* Start for Enabled SubSystem: '<S320>/Enabled Subsystem' */
  /* Start for IfAction SubSystem: '<S321>/If Action Subsystem1' */
  /* Start for S-Function (ec5744_cantransmitslb): '<S326>/CANTransmit' incorporates:
   *  Constant: '<S326>/Constant'
   */
  ec_buffer_init(2,9,0,593U);

  /* End of Start for SubSystem: '<S321>/If Action Subsystem1' */
  /* End of Start for SubSystem: '<S320>/Enabled Subsystem' */
  ec_buffer_init(2,1,0,278);

  /* End of Start for S-Function (ec5744_canreceiveslb): '<S319>/CANReceive' */
  /* End of Start for S-Function (fcncallgen): '<S315>/100MS' */

  /* Start for S-Function (fcncallgen): '<S318>/Function-Call Generator' incorporates:
   *  SubSystem: '<S318>/CCPBackground'
   */
  /* Start for S-Function (ec5744_ccpslb): '<S333>/CCPBackground' */
  ccpInit();

  /* End of Start for S-Function (fcncallgen): '<S318>/Function-Call Generator' */

  /* Start for S-Function (ec5744_caninterruptslb1): '<S318>/ReceiveandTransmitInterrupt' incorporates:
   *  SubSystem: '<S318>/CCPReceive'
   */
  /* Start for function-call system: '<S318>/CCPReceive' */

  /* Start for S-Function (ec5744_canreceiveslb): '<S334>/CANReceive' */
  ec_buffer_init(2,0,0,CCP_CRO_ID);

  /* End of Start for S-Function (ec5744_canreceiveslb): '<S334>/CANReceive' */
  ec_bufint_init(2,0);
  INTC_0.PSR[548].B.PRIN = 12;
  IntcIsrVectorTable[548] = (uint32_t)&ISR_FlexCAN_2_MB0;

  /* End of Start for S-Function (ec5744_caninterruptslb1): '<S318>/ReceiveandTransmitInterrupt' */
   ...
   *  SubSystem: '<S4>/Subsystem'
   */
  /* InitializeConditions for UnitDelay: '<S237>/Unit Delay4' */
